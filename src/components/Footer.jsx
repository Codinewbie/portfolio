...
const Footer = () => {
  ...
  return (
    <div className="bg-neutral-800 flex justify-center px-7">
      <div className="max-w-4xl text-white py-16 flex justify-between w-full gap-14 items-center flex-col md:flex-row">
        {/* Copyright Section */}
        ...
        <div className="flex items-center gap-5 text-4xl">
          ...
          <a
            href="https://leetcode.com/u/aman_online67/"
            title="Leetcode"
            target="_blank"
            rel="noopener noreferrer"
            className="duration-300 hover:text-blue-500"
          >
            <svg
              ...
              strokeWidth="2"
            >
              <path d="M12 13h7.5M9.424 7.268l4.999-4.999m2.21 14.375l-2.402 2.415a3.19 3.19 0 0 1-4.524 0l-3.77-3.787a3.223 3.223 0 0 1 0-4.544l3.77-3.787a3.19 3.19 0 0 1 4.524 0l2.302 2.313" />
            </svg>
          </a>
          <a
