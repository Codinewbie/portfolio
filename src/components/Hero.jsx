...
import amanu from '/src/images/aman2.jpg';
import resume from '/src/pdfs/resume.pdf';
  ...
  return (
    <header id="Home">
      <div className="py-16 flex flex-col-reverse gap-10 text-center md:text-left md:flex-row items-center md:justify-between">
        <div>
          <h2 className="text-3xl font-extrabold md:text-5xl font-black mb-5 leading-tight">
          ...
          <div className="flex items-center justify-center md:justify-start text-4xl gap-4">
            <a href="https://github.com/Codinewbie" title="GitHub" target="_blank" rel="noopener noreferrer">
              <i className="bx bxl-github duration-300 hover:text-blue-600"></i>
            </a>
            <a href="https://www.linkedin.com/in/aman-kumar-559110250/" title="LinkedIn" target="_blank" rel="noopener noreferrer">
              <i className="bx bxl-linkedin-square duration-300 hover:text-blue-600"></i>
            </a>
            <a href="https://leetcode.com/u/aman_online67/" title="Leetcode" target="_blank" rel="noopener noreferrer">
              <svg
            ...
            <a
              href="https://www.codechef.com/users/aman_online67"
              title="CodeChef"
              target="_blank"
            ...
            <a
              href="https://drive.google.com/file/d/1SVvQBKL-oMJneOtvIXpniCg4KEflefAz/view?usp=drivesdk"
              title="Resume"
              target="_blank"
              rel="noopener noreferrer"
              className="duration-300 bg-gray-900 text-white text-sm px-2 py-[7px] ml-1 rounded-md hover:opacity-80 "
              >
                Resume
            </a>
          </div>
        ...
        <div className="flex justify-center md:justify-start">
          <img
            src={amanu}
            alt="Aman Kumar"
            className="rounded-lg grayscale w-48 h-48 object-cover"
          />
        </div>
      </div>
    </header>
